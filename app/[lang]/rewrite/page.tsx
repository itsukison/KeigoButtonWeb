...
const TOC = [
  { id: "modes", text: "What the four modes do" },
  { id: "two", text: "Why two candidates" },
  { id: "limits", text: "The limits, stated plainly" },
  { id: "app", text: "Without the copy and paste" },
...
export const metadata: Metadata = {
  title: {
    absolute: "Free English Rewriter — Make Your Writing Sound Natural",
  },
  description:
  ...
  twitter: {
    ...
    title: "Free English Rewriter",
    description:
      "Fix the grammar, make it natural, make it professional. Free, no account.",
              ...
              <div className="mac-doc__main">
                ...
                <div className="mac-doc__body">
                  ...
                  <ul className="mac-doc__list">
                    <li>
                      <strong>Natural</strong> — for writing that is
                      grammatically fine but reads as translated. It fixes word
                      order, collocations and the small idiom choices that mark
                      a sentence as non-native, without changing your meaning.
                    </li>
                    <li>
                      <strong>Grammar</strong> — the conservative one. It
                      corrects mistakes and leaves everything else alone,
                      including sentence structure and register. Use it when you
                      want to sound like yourself, only correct.
                    </li>
                    <li>
                      <strong>Professional</strong> — for a manager, a client,
                      or someone you do not know. Blunt instructions become
                      polite requests; it aims for warm and direct rather than
                      stiff.
                    </li>
                    <li>
                      <strong>Shorter</strong> — cuts hedging and filler and
                      moves the ask to the front, while keeping every name,
                      number, date and deadline.
                    </li>
                  </ul>
                  ...
                  <p className="mac-doc__p">
                    One answer looks authoritative and hides the fact that
                    register is a choice. Two lets you see the range — the first
                    is straightforward, the second is a step more polished — and
                    pick the one that fits who you are writing to. It also makes
                    it obvious when the model has misread you, which a single
                  ...
                  <ul className="mac-doc__list">
                    <li>
                      <strong>Five a day, 300 characters.</strong> The cap is
                      per IP address, so a shared office or campus connection
                      will hit it sooner than one person would.
                    </li>
                    <li>
                      <strong>Your text is sent to a server.</strong> It is not
                      kept after the rewrite, but it does leave your machine. If
                      that is not acceptable, use a tool that runs locally.
                    </li>
                    <li>
                      <strong>It edits; it does not draft.</strong> Give it
                      something to work on. For writing from nothing, or for
                      talking through what to say, a chat assistant is the
                      better tool.
                    </li>
                    <li>
                      <strong>It is still a browser tab.</strong> You copy in
                      and paste back — which is the exact loop the Mac app
                      exists to remove.
                    </li>
                  </ul>
                  ...
                  <aside className="mac-doc__callout">
                    ...
                    <p className="mac-doc__p">
                      If you have an Apple silicon Mac, Writing Tools is built
                      into macOS, costs nothing and runs much of its work
                      on-device — right-click any selected text. Grammarly and
                      LanguageTool both have genuinely useful free tiers for
                      correction. We would rather you knew that than found out
                      afterwards; the comparison is written out in{" "}
                  ...
                  <p className="mac-doc__p">
                    ...
                    bottom of your Mac screen: hover it, press one of your own
                    buttons, and the text you are already typing is rewritten in
                    place — in Mail, Slack, Gmail, Notion, Word or anywhere else
                    you can put a cursor. The buttons are instructions you write
                    once, and they sync to an iPhone keyboard so the same ones
                    are there on your phone.
                  </p>
                </div>
                ...
                <section aria-labelledby="related-heading">
                  ...
                  <div className="mac-doc__related">
                    ...
                    <Link
                      href="/en/grammarly-alternative-mac"
                      className="mac-doc__relatedCard"
                    >
                      <span className="mac-doc__relatedTitle">
